...
const TicketPreviewPopup = ({
  selectedSeats = ["A1", "A2"], // Default values for demo
  currentShow = {
    movie: "Avengers: Endgame",
    time: "7:00 PM",
    date: "2025-08-10",
    price: 500, // This should be price per seat
  },
  onClose = () => {},
  ...
  // Create a new window for printing with Tailwind CSS
  const printWindow = window.open("", "_blank");
      ...
      <div class="flex flex-col gap-8 max-w-4xl mx-auto">
        ${selectedSeats
          .map((seat) => {
            ...
            return `
              <div class="bg-white rounded-2xl shadow-2xl overflow-hidden mb-8 print:mb-0 print:shadow-none">
                <div class="bg-gray-900 text-white p-6 relative ticket-header" style="background: #1a1a1a !important; -webkit-print-color-adjust: exact; color-adjust: exact; print-color-adjust: exact;">
                  ...
                  <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="bg-white bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center text-xl">
                      🎬
                    </div>
                  </div>
                  <div class="text-right">
                    <div class="text-xs opacity-80 mb-1">Booking ID</div>
                    <div class="font-mono text-lg font-bold">${bookingId}</div>
                  </div>
                </div>
                    ...
                    <div>
                      <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <div class="font-semibold text-gray-900">${new Date(
                            showDate
                          ).toLocaleDateString()} • ${showTime}</div>
                        </div>
                      </div>
                      ...
                      <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <div class="font-semibold text-gray-900">${seat}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <div class="font-semibold text-gray-900">${theatreName}</div>
                        </div>
                      </div>
                      ...
                      <div class="flex items-center gap-3 mb-4">
                        <div class="text-orange-500 text-xl">🎫</div>
                        <div>
                          <div class="text-xs text-gray-600 mb-0.5">Screen</div>
                          <div class="font-semibold text-gray-900">Screen 1</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  
                  <div class="flex justify-between items-center pt-5 border-t-2 border-dashed border-gray-300">
                    ...
                    <div class="text-right">
                      <div class="text-xs text-gray-600 mb-1">Amount Paid</div>
                      <div class="text-2xl font-bold text-orange-500">₹${pricePerSeat.toFixed(
                        2
                      )}</div>
                    </div>
                  </div>
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      printWindow.close();
      setIsPrinting(false);
      notify.success("Printing completed!");
      onPrintComplete();
    }, 1000);
  }, 1500);
};
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="font-medium text-sm">{seat}</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="font-medium text-sm">Screen 1</div>
                          </div>
                        </div>
                      </div>
                    </div>
